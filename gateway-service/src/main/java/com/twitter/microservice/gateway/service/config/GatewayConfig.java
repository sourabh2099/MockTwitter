...
import com.twitter.microservice.config.GatewayServiceConfiguration;
...
public class GatewayConfig {
    private final GatewayServiceConfiguration gatewayServiceConfigData;

    private static final String HEADER_FOR_KEY_RESOLVER = "Authorization";

    public GatewayConfig(GatewayServiceConfiguration gatewayServiceConfigData) {
